...
static uint32_t esc_palette_8_bright[] = {
  0x7d7a68, /* Black   */
  0xd73737, /* Red     */
  0x60ac39, /* Green   */
  0xae9513, /* Yellow  */
...
/* Taken from https://jonasjacek.github.io/colors
 *   using the following Javascript code:
 *
 * let out='';
 * [].forEach.call(document.querySelectorAll('td:nth-child(4'), (e,i)=>{
 *   if(i%4 == 0){
 *     out+='\n';
 *   }
 *   out+=e.innerText.replace('#','0x')+', ';
 * });
 * console.log(out);
 */
static uint32_t esc_palette_256[] = {
